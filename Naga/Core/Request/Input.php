...
class Input extends nComponent
{
	...
	/**
	 * Gets files uploaded with <input type="file" multiple>. Returns a number indexed
	 * array filled with $fileClassName instances.
	 *
	 * @param string $name
	 * @param string $fileClassName
	 * @return array
	 ...
	 * but you can use keep(), keepOnly(), keepExcept() to keep these items between requests.
	 *
	 * @param mixed $name
	 * @param mixed $value
